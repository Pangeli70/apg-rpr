...
export class ApgWgl_Viewer {
    ...
    protected window: ApgGui_IBrowserWindow;
    /** We don't like global objects */
    ...
    protected viewerCanvasElement!: ApgGui_ICanvas;
    ...
    orbitControls!: THREE_OrbitControls;
    ...
    /** Logger name */
    static readonly WGL_VIEWER_LOGGER_NAME = 'Web GL Viewer';
    ...
    #initCanvas() {
        ...
        this.viewerCanvasElement = this.document.createElement('canvas') as ApgGui_ICanvas;
