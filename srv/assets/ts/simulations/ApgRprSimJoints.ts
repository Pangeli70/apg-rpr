...
export interface ApgRprSim_Joints_IGuiSettings extends ApgRprSim_IGuiSettings {
...
export class ApgRprSim_Joints extends ApgRprSim_Base {
    ...
    #createWorld(asettings: ApgRprSim_Joints_IGuiSettings) {
    ...
    override defaultGuiSettings() {
        ...
        const r: ApgRprSim_Joints_IGuiSettings = {
...
export class ApgRprSim_Joints_GuiBuilder extends ApgRprSim_GuiBuilder {
    ...
    guiSettings: ApgRprSim_Joints_IGuiSettings;
    ...
    constructor(
        ...
        this.guiSettings = this.params.guiSettings as ApgRprSim_Joints_IGuiSettings;
    }
