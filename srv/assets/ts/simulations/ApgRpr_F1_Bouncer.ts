...
interface ApgRpr_F1_Flipper_ISimulationSettings extends ApgRpr_ISimulationSettings {

}



export class ApgRpr_F1_Flipper_Simulation extends ApgRpr_Simulation {
    ...
    constructor(
        ...
        this.buildGui(ApgRprSim_F1_Flipper_GuiBuilder);

        const settings = this.params.settings! as ApgRpr_F1_Flipper_ISimulationSettings;
    ...
    protected override createWorld(asettings: ApgRpr_F1_Flipper_ISimulationSettings) {
    ...
    override defaultSettings() {
        ...
        const r: ApgRpr_F1_Flipper_ISimulationSettings = {
...
class ApgRprSim_F1_Flipper_GuiBuilder extends ApgRpr_Simulator_GuiBuilder {

    private _guiSettings: ApgRpr_F1_Flipper_ISimulationSettings;
    ...
    constructor(
        ...
        this._guiSettings = asettings as ApgRpr_F1_Flipper_ISimulationSettings;
    }
