...
export interface ApgRpr_I1_AvoidTheRed_ISimulationSettings extends ApgRpr_ISimulationSettings {
...
export class ApgRpr_I1_AvoidTheRed_Simulation extends ApgRpr_Simulation {
    ...
    constructor(
        ...
        this.buildGui(ApgRpr_I1_AvoidTheRed_GuiBuilder);

        const settings = this.params.settings! as ApgRpr_I1_AvoidTheRed_ISimulationSettings;
    ...
    protected override createWorld(asettings: ApgRpr_I1_AvoidTheRed_ISimulationSettings) {
    ...
    override defaultSettings() {
        ...
        const r: ApgRpr_I1_AvoidTheRed_ISimulationSettings = {
...
export class ApgRpr_I1_AvoidTheRed_GuiBuilder extends ApgRpr_Simulator_GuiBuilder {

    private _guiSettings: ApgRpr_I1_AvoidTheRed_ISimulationSettings;
    ...
    constructor(
        ...
        this._guiSettings = asettings as ApgRpr_I1_AvoidTheRed_ISimulationSettings;
    }
